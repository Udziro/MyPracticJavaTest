...
public class checkDateType {
    ...
    By selectDateButton = By.cssSelector("span.input-group-addon");
//    By selectDateButton = By.xpath("//span[@class = \"input-group-addon\"]");
    ...
    public void checkTheCorrectDateType(){
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(selectDateButton));
        driver.findElement(By.cssSelector("input.form-control")).sendKeys("11/16/2020");
